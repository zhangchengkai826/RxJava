...
If you want to update this library, you will feel much easier when you use Git to do the version controll. What's more, because of this library is designed based on JVM, it will make your life easier if you use the following tools: Java JDK.
