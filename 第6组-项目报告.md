...
# Evolution Perspective
 ...
 Through out the years, RxJava has evolved a lot. And up to now, it has already 221 releases, starting from xxxxx. 
 All versions of RxJava can be found on the GitHub repository, with 1.x, 2.x and 3.x being at different branches. RxJava got end-of-life at March 31,2018. Compared with 1.x, Version 2.x had changed a lot especially at **API**, although the ideas of using are almost the same. 0 has been completely rewritten from scratch on top of the Reactive-Streams specification. The specification itself has evolved out of RxJava 1.x and provides a common baseline for reactive systems and libraries.
   ...
   + It added the visual time and schedulers for parameterized concurrency.

   + It became non-opinion about source of concurrency.

        As for Version 3.x, some others changes are as follows:
